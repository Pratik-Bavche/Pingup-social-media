      ...
      <div className="flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40 relative z-10">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-3 max-md:mt-10">
            <img src={assets.group_users} className="h-8 md:h-10" alt="users" />
            <div>
              <div className="flex">
                {Array(5)
                  .fill(0)
          ...
          <p className="text-xl md:text-3xl text-indigo-900 max-w-72 md:max-w-md">connct with global community on pingup.</p>
        </div>
        <span className="md:h-50"></span>
      </div>
      {/* login form */}
